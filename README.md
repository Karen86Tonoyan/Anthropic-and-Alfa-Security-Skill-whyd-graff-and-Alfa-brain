...
[![Skills](https://img.shields.io/badge/skills-756-brightgreen?style=flat-square)](#whats-inside--26-security-domains)
...
**756 production-grade cybersecurity skills · 26 security domains · 5 framework mappings · 26+ AI platforms**
...
This repo contains **756 structured cybersecurity skills** spanning **26 security domains**, each following the [agentskills.io](https://agentskills.io) open standard.  754 of 756 skills are mapped to **five industry frameworks** — MITRE ATT&CK, NIST CSF 2.0, MITRE ATLAS, MITRE D3FEND, and NIST AI RMF  — making this the only open-source skills library with unified cross-framework coverage.  Clone it, point your agent at it, and your next security investigation gets expert-level guidance in seconds.
...
Each skill costs **~30 tokens to scan** (frontmatter only)  and **500–2,000 tokens to fully load** (complete workflow). This progressive disclosure architecture lets agents search all 756 skills in a single pass without blowing context windows. 
...
Agent's internal process:
  ...
  1. Scans 756 skill frontmatters (~30 tokens each)
...
Skills have continued to grow on `main` since v1.0.0 — the library now contains **756 skills** with **5-framework mapping**  (MITRE ATLAS, D3FEND, and NIST AI RMF added post-release).  Check [Releases](https://github.com/mukul975/Anthropic-Cybersecurity-Skills/releases) for the latest tagged version.
...
@software{anthropic_cybersecurity_skills,
  ...
  license      = {Apache-2.0},
  note         = {756 structured cybersecurity skills for AI agents,
